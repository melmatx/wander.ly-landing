...
import { idlFactory } from './wanderly_landing.did.js';
export { idlFactory } from './wanderly_landing.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.WANDERLY_LANDING_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./wanderly_landing.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the wanderly_landing canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./wanderly_landing.did.js")._SERVICE>}
 */
export const wanderly_landing = createActor(canisterId);
